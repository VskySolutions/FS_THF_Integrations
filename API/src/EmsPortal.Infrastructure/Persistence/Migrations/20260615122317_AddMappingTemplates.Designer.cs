...
namespace EmsPortal.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260615122317_AddMappingTemplates")]
    partial class AddMappingTemplates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmsPortal.Domain.Entities.MappingTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "SourceSystem", "TargetSystem")
                        .IsUnique()
            ...
            modelBuilder.Entity("EmsPortal.Domain.Entities.MappingConfiguration", b =>
                {
                    b.HasOne("EmsPortal.Domain.Entities.MappingTemplate", "Template")
                        .WithMany("Fields")
