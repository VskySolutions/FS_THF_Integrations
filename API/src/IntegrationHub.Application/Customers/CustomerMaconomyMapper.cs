...
public sealed class CustomerMaconomyMapper : ICustomerMaconomyMapper
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultMap = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Country"] = nameof(CustomerRequest.Country),
        ["State"] = nameof(CustomerRequest.StateProvince),
        ["City"] = nameof(CustomerRequest.City),
        ["AddressLine1"] = nameof(CustomerRequest.AddressLine1),
        ["AddressLine2"] = nameof(CustomerRequest.AddressLine2),
        ["PostalCode"] = nameof(CustomerRequest.PostalCode),
    ...
    private static Dictionary<string, object?> SourceFields(CustomerRequest r) => new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        [nameof(r.Country)] = r.Country,
        [nameof(r.StateProvince)] = r.StateProvince,
        [nameof(r.City)] = r.City,
        [nameof(r.AddressLine1)] = r.AddressLine1,
        [nameof(r.AddressLine2)] = r.AddressLine2,
        [nameof(r.PostalCode)] = r.PostalCode,
