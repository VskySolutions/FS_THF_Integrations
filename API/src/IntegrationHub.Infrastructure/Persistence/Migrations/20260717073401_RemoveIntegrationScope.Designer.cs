...
namespace IntegrationHub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260717073401_RemoveIntegrationScope")]
    partial class RemoveIntegrationScope
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.ActivityEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.Checklist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.ChecklistItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.ColourCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.DeletedRecordRetentionConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.EntityTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.FieldModifiedLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.ModifiedLogFieldConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.NotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.OptionSet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.OptionSetItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.Pin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.Reminder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.SavedView", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.StickyNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.StickyNoteDismissal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.UserGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.UserGroupMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.UserStickyNoteState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.ChecklistItem", b =>
                {
                    b.HasOne("IntegrationHub.Domain.Entities.Checklist", "Checklist")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.EntityTag", b =>
                {
                    b.HasOne("IntegrationHub.Domain.Entities.Tag", "Tag")
                        .WithMany("EntityTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.OptionSet", b =>
                {
                    b.HasOne("IntegrationHub.Domain.Entities.OptionSet", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.OptionSetItem", b =>
                {
                    b.HasOne("IntegrationHub.Domain.Entities.OptionSet", "OptionSet")
                        .WithMany("Items")
                        .HasForeignKey("OptionSetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IntegrationHub.Domain.Entities.OptionSetItem", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.StickyNoteDismissal", b =>
                {
                    b.HasOne("IntegrationHub.Domain.Entities.StickyNote", "StickyNote")
                        .WithMany("Dismissals")
            ...
            modelBuilder.Entity("IntegrationHub.Domain.Entities.UserGroupMember", b =>
                {
                    b.HasOne("IntegrationHub.Domain.Entities.UserGroup", "UserGroup")
                        .WithMany("Members")
